...
(function (global) {
 ...
 delete: 'Padam', edit: 'Edit', add: 'Tambah', close: 'Tutup', back: 'Kembali',
    ...
    nav: {
      ...
      acc: 'Perakaunan (ACC)', income_statement: 'Penyata Pendapatan', balance_sheet: 'Kunci Kira-kira', cashflow_statement: 'Penyata Aliran Tunai', analytics: 'Analitik',
    ...
    expenses: {
      ...
      monthly: 'Bulanan', annual: 'Tahunan', fixed: 'Tetap', variable: 'Berubah', type: 'Jenis', growth: 'Pertumbuhan',
    ...
    acc: {
      title: 'Perakaunan (ACC)', tab_is: 'Penyata Pendapatan', tab_bs: 'Kunci Kira-kira', tab_cf: 'Penyata Aliran Tunai',
      recap: 'Penyesuaian: Untung Bersih mengalir ke Pendapatan Tertahan & Aliran Tunai Operasi; tunai akhir Kunci Kira-kira = tunai akhir Penyata Aliran Tunai.',
      is_revenue: 'Hasil', is_var_cogs: 'COGS Berubah', is_fixed_cogs: 'COGS Tetap', is_gross_profit: 'UNTUNG KASAR',
      is_var_overhead: 'Overhed Berubah', is_fixed_overhead: 'Overhed Tetap', is_ebitda: 'EBITDA / Pendapatan Operasi',
      is_da: 'Susut Nilai & Pelunasan', is_ebit: 'EBIT', is_tax: 'Cukai', is_net_income: 'UNTUNG BERSIH (NI)',
      bs_assets: 'ASET', bs_current_assets: 'Aset Semasa', bs_cash: 'Tunai & Setara', bs_ar: 'Akaun Belum Terima',
      bs_inventory: 'Inventori', bs_other_current: 'Aset Semasa Lain', bs_prepaid: 'Belanja Prabayar', bs_total_current: 'Jumlah Aset Semasa',
      bs_fixed_assets: 'Aset Tetap', bs_total_assets: 'JUMLAH ASET', bs_liab: 'LIABILITI', bs_current_liab: 'Liabiliti Semasa',
      bs_ap: 'Akaun Belum Bayar', bs_tax_payable: 'Cukai Belum Bayar',
      bs_total_current_liab: 'Jumlah Liabiliti Semasa', bs_lt_liab: 'Liabiliti Jangka Panjang', bs_lt_debt: 'Hutang Jangka Panjang',
      bs_total_liab: 'JUMLAH LIABILITI', bs_equity: 'EKUITI', bs_contributed: 'Modal Disumbang', bs_re: 'Pendapatan Tertahan',
      bs_total_equity: 'Jumlah Ekuiti', bs_tlse: 'JUMLAH LIABILITI & EKUITI', bs_balance_ok: 'Lembaran seimbang: Aset = Liabiliti + Ekuiti ✓',
      bs_balance_bad: 'Lembaran TIDAK seimbang — semak data input.',
      bs_closing_cash_note: 'Tunai akhir menyamai Tunai Akhir dalam Penyata Aliran Tunai (tunai penutup tempoh sebelumnya + jumlah aliran operasi, pelaburan & pembiayaan).',
      cf_title: 'Penyata Aliran Tunai (Kaedah Tidak Langsung)', cf_operating_activities: 'AKTIVITI OPERASI',
      cf_net_income: 'Untung Bersih', cf_da: 'Susut Nilai & Pelunasan', cf_d_ar: 'Tambahan/(Pengurangan) Akaun Belum Terima',
      cf_d_inv: 'Tambahan/(Pengurangan) Inventori', cf_d_prepaid: 'Tambahan/(Pengurangan) Belanja Prabayar', cf_d_ap: 'Penambahan/(Pengurangan) Akaun Belum Bayar',
      cf_d_tax: 'Penambahan/(Pengurangan) Cukai Belum Bayar', cf_net_operating: 'Tunai bersih daripada aktiviti operasi',
      cf_investing: 'AKTIVITI PELABURAN', cf_capex: 'Perbelanjaan modal', cf_proceeds_equip: 'Hasil jualan peralatan',
      cf_proceeds_inv: 'Hasil jualan pelaburan', cf_net_investing: 'Tunai bersih daripada aktiviti pelaburan',
      cf_financing: 'AKTIVITI PEMBIAYAAN', cf_debt_pay: 'Bayaran hutang jangka panjang', cf_debt_issue: 'Hasil terbitan hutang jangka panjang',
      cf_stock_issue: 'Hasil terbitan saham biasa', cf_dividends: 'Dividen dibayar', cf_treasury: 'Pembelian saham perbendaharaan',
      cf_net_financing: 'Tunai bersih daripada aktiviti pembiayaan', cf_begin_cash: 'Tunai awal', cf_end_cash: 'Tunai akhir',
      cf_note_indirect: 'Kaedah tidak langsung: bermula daripada Untung Bersih dan menyelaras item bukan tunai serta perubahan modal kerja.',
      flow_ni_re: 'Untung Bersih → Pendapatan Tertahan (Kunci Kira-kira)', flow_ni_cf: 'Untung Bersih → Aliran Tunai Operasi',
      flow_fa_cf: 'Perubahan Aset Tetap → Aliran Tunai Pelaburan', flow_debt_cf: 'Hutang & Ekuiti pembukaan → Aliran Tunai Pembiayaan',
      flow_cash_bs: 'Tunai akhir CF → Tunai pada Kunci Kira-kira'
    },
    analytics: {
      title: 'Papan Analitik', subtitle: 'Cerapan boleh tindak daripada data kewangan anda.',
      monthly_trend: 'Trend Jualan Bulanan', sales_by_product: 'Jualan & Untung mengikut Produk',
      sales_vs_cogs: 'Jualan vs COGS', discount_band: 'Analisis Jalur Diskaun', profit_contribution: 'Sumbangan Untung mengikut Produk',
      total_revenue: 'Jumlah Hasil', total_cogs: 'Jumlah COGS', gross_profit: 'Untung Kasar', net_profit: 'Untung Bersih',
      gross_margin: 'Margin Kasar', avg_discount: 'Purata Diskaun', peak_month: 'Bulan Puncak', sales: 'Jualan', profit: 'Untung',
      vs_last_year: 'berbanding tahun lepas', vs_prev_year: 'vs tahun sebelumnya',
      no_products: 'Tiada produk/aliran hasil ditetapkan.', all_products: 'Semua Produk', all_bands: 'Semua Jalur Diskaun', all_months: 'Semua Bulan',
      year: 'Tahun', product: 'Produk', band: 'Jalur Diskaun', revenue: 'Hasil', cogs_label: 'COGS',
      contribution_pct: '% Sumbangan', no_discount: 'Tiada Diskaun', month: 'Bulan', value: 'Nilai',
      slicers: 'Penapis Interaktif', kpi_sales: 'Jualan', kpi_gp: 'Untung Kasar', kpi_gm: 'Margin Kasar', kpi_np: 'Untung Bersih',
      select_all: 'Semua', clear: 'Padam', apply: 'Guna', reset: 'Set Semula',
      trend_up: 'Meningkat', trend_down: 'Menurun', trend_flat: 'Stabil', best_product: 'Produk Terbaik',
      metrics_context: 'Penunjuk arah aliran dikira berbanding tempoh sebelumnya yang setara.'
    },
    wc: {
    ...
    reports: {
      ...
      acc: 'Perakaunan (3 Penyata)', analytics: 'Analitik',
 ...
 delete: 'Delete', edit: 'Edit', add: 'Add', close: 'Close', back: 'Back',
    ...
    nav: {
      ...
      acc: 'Accounting (ACC)', income_statement: 'Income Statement', balance_sheet: 'Balance Sheet', cashflow_statement: 'Cash Flow Statement', analytics: 'Analytics',
    ...
    expenses: {
      ...
      monthly: 'Monthly', annual: 'Annual', fixed: 'Fixed', variable: 'Variable', type: 'Type', growth: 'Growth',
    ...
    acc: {
      title: 'Accounting (ACC)', tab_is: 'Income Statement', tab_bs: 'Balance Sheet', tab_cf: 'Cash Flow Statement',
      recap: 'Reconciliation: Net Income flows to Retained Earnings & Operating Cash Flow; Balance Sheet closing cash = closing cash on the Cash Flow Statement.',
      is_revenue: 'Revenue', is_var_cogs: 'Variable COGS', is_fixed_cogs: 'Fixed COGS', is_gross_profit: 'GROSS PROFIT',
      is_var_overhead: 'Variable Overhead', is_fixed_overhead: 'Fixed Overhead', is_ebitda: 'EBITDA / Operating Income',
      is_da: 'Depreciation & Amortization', is_ebit: 'EBIT', is_tax: 'Tax', is_net_income: 'NET INCOME (NI)',
      bs_assets: 'ASSETS', bs_current_assets: 'Current Assets', bs_cash: 'Cash & Equivalents', bs_ar: 'Accounts Receivable',
      bs_inventory: 'Inventory', bs_other_current: 'Other Current Assets', bs_prepaid: 'Prepaid Expenses', bs_total_current: 'Total Current Assets',
      bs_fixed_assets: 'Fixed Assets', bs_total_assets: 'TOTAL ASSETS', bs_liab: 'LIABILITIES', bs_current_liab: 'Current Liabilities',
      bs_ap: 'Accounts Payable', bs_tax_payable: 'Taxes Payable',
      bs_total_current_liab: 'Total Current Liabilities', bs_lt_liab: 'Long-Term Liabilities', bs_lt_debt: 'Long-Term Debt',
      bs_total_liab: 'TOTAL LIABILITIES', bs_equity: 'EQUITY', bs_contributed: 'Contributed Capital', bs_re: 'Retained Earnings',
      bs_total_equity: 'Total Equity', bs_tlse: 'TOTAL LIABILITIES & EQUITY', bs_balance_ok: 'Balanced: Assets = Liabilities + Equity ✓',
      bs_balance_bad: 'NOT balanced — check your inputs.',
      bs_closing_cash_note: 'Closing cash equals Closing Cash on the Cash Flow Statement (prior-period closing cash + operating, investing & financing flows).',
      cf_title: 'Cash Flow Statement (Indirect Method)', cf_operating_activities: 'OPERATING ACTIVITIES',
      cf_net_income: 'Net Income', cf_da: 'Depreciation & Amortization', cf_d_ar: '(Increase)/decrease in Accounts Receivable',
      cf_d_inv: '(Increase)/decrease in Inventories', cf_d_prepaid: '(Increase)/decrease in Prepaid Expenses', cf_d_ap: 'Increase/(decrease) in Accounts Payable',
      cf_d_tax: 'Increase/(decrease) in Taxes Payable', cf_net_operating: 'Net cash provided by operating activities',
      cf_investing: 'INVESTING ACTIVITIES', cf_capex: 'Capital expenditures', cf_proceeds_equip: 'Proceeds from sales of equipment',
      cf_proceeds_inv: 'Proceeds from sales of investments', cf_net_investing: 'Net cash used in investing activities',
      cf_financing: 'FINANCING ACTIVITIES', cf_debt_pay: 'Payments of long-term debt', cf_debt_issue: 'Proceeds from issuance of long-term debt',
      cf_stock_issue: 'Proceeds from issuance of common stock', cf_dividends: 'Dividends paid', cf_treasury: 'Purchase of treasury stock',
      cf_net_financing: 'Net cash used in financing activities', cf_begin_cash: 'Beginning cash balance', cf_end_cash: 'Ending cash balance',
      cf_note_indirect: 'Indirect method: starts from Net Income and adjusts for non-cash items and working-capital changes.',
      flow_ni_re: 'Net Income → Retained Earnings (Balance Sheet)', flow_ni_cf: 'Net Income → Operating Cash Flow',
      flow_fa_cf: 'Fixed Assets change → Investing Cash Flows', flow_debt_cf: 'Opening debt & equity → Financing Cash Flows',
      flow_cash_bs: 'CF closing cash → Cash on the Balance Sheet'
    },
    analytics: {
      title: 'Analytics Dashboard', subtitle: 'Actionable insights from your financial data.',
      monthly_trend: 'Monthly Sales Trend', sales_by_product: 'Sales & Profit by Product',
      sales_vs_cogs: 'Sales vs COGS', discount_band: 'Discount Band Analysis', profit_contribution: 'Product-wise Profit Contribution',
      total_revenue: 'Total Revenue', total_cogs: 'Total COGS', gross_profit: 'Gross Profit', net_profit: 'Net Profit',
      gross_margin: 'Gross Margin', avg_discount: 'Avg Discount', peak_month: 'Peak Month', sales: 'Sales', profit: 'Profit',
      vs_last_year: 'vs last year', vs_prev_year: 'vs previous year',
      no_products: 'No product/revenue streams defined.', all_products: 'All Products', all_bands: 'All Discount Bands', all_months: 'All Months',
      year: 'Year', product: 'Product', band: 'Discount Band', revenue: 'Revenue', cogs_label: 'COGS',
      contribution_pct: '% Contribution', no_discount: 'No Discount', month: 'Month', value: 'Value',
      slicers: 'Interactive Filters', kpi_sales: 'Sales', kpi_gp: 'Gross Profit', kpi_gm: 'Gross Margin', kpi_np: 'Net Profit',
      select_all: 'All', clear: 'Clear', apply: 'Apply', reset: 'Reset',
      trend_up: 'Rising', trend_down: 'Falling', trend_flat: 'Flat', best_product: 'Best Product',
      metrics_context: 'Trend indicators compare against the equivalent prior period.'
    },
    wc: {
    ...
    reports: {
      ...
      acc: 'Accounting (3 Statements)', analytics: 'Analytics',
